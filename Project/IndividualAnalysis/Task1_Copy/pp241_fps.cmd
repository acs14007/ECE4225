...
struct tdr=n241_MOS1 ; # Saving after gate oxidation
...
struct tdr=n241_MOS2 ; # Saving after gate patterning



implant Arsenic dose=1e15 energy=20 tilt=0 rotation=0  
diffuse temperature=1050<C> time=0.1<s> ; # Quick activation 
struct tdr=n241_MOS3 ; # Saving after LDD Implant
...
struct tdr=n241_MOS4 ; # Saving after HALO Implant



deposit nitride isotropic thickness= 0.3*0.36
etch  nitride anisotropic thickness= 0.35*0.36
struct tdr=n241_MOS5 ; # Saving after spacer formation
...
struct tdr=n241_MOS6 ; # Saving after souce/drain implantation
...
struct tdr=n241 !Gas !interfaces
exit
