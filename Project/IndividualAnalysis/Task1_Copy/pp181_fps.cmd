...
struct tdr=n181_MOS1 ; # Saving after gate oxidation
...
struct tdr=n181_MOS2 ; # Saving after gate patterning



implant Arsenic dose=1e13 energy=20 tilt=0 rotation=0  
diffuse temperature=1050<C> time=0.1<s> ; # Quick activation 
struct tdr=n181_MOS3 ; # Saving after LDD Implant



implant Boron dose=1e10 energy=30 tilt=30<degree> rotation=0<degree>
implant Boron dose=1e10 energy=30 tilt=30<degree> rotation=90<degree>
implant Boron dose=1e10 energy=30 tilt=30<degree> rotation=180<degree>
implant Boron dose=1e10 energy=30 tilt=30<degree> rotation=270<degree>



diffuse temperature=1050<C> time=5.0<s>
struct tdr=n181_MOS4 ; # Saving after HALO Implant



deposit nitride isotropic thickness= 0.3*0.36
etch  nitride anisotropic thickness= 0.35*0.36
struct tdr=n181_MOS5 ; # Saving after spacer formation
...
struct tdr=n181_MOS6 ; # Saving after souce/drain implantation
...
struct tdr=n181 !Gas !interfaces
exit
