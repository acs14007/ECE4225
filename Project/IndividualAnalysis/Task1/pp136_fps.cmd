...
line y location= 0.0      spacing= 0.1*0.12  tag= Mid
line y location= 0.5*0.12 spacing= 0.05*0.12
line y location= 2*0.12   spacing= 0.12      tag= Right 
...
struct tdr=n136_MOS1 ; # Saving after gate oxidation
...
mask name=gate_mask left=-0.12/2 right= 0.12/2
...
struct tdr=n136_MOS2 ; # Saving after gate patterning



implant Arsenic dose=1e13 energy=20 tilt=0 rotation=0  
diffuse temperature=1050<C> time=0.1<s> ; # Quick activation 
struct tdr=n136_MOS3 ; # Saving after LDD Implant



implant Boron dose=1e12 energy=30 tilt=30<degree> rotation=0<degree>
implant Boron dose=1e12 energy=30 tilt=30<degree> rotation=90<degree>
implant Boron dose=1e12 energy=30 tilt=30<degree> rotation=180<degree>
implant Boron dose=1e12 energy=30 tilt=30<degree> rotation=270<degree>



diffuse temperature=1050<C> time=5.0<s>
struct tdr=n136_MOS4 ; # Saving after HALO Implant



deposit nitride isotropic thickness= 0.3*0.12
etch  nitride anisotropic thickness= 0.35*0.12
struct tdr=n136_MOS5 ; # Saving after spacer formation
...
struct tdr=n136_MOS6 ; # Saving after souce/drain implantation



deposit material= {Aluminum} type=anisotropic thickness= 0.05
mask name= contacts_mask left=0.12*1.2
...
contact name=source point y=-0.12*1.5 x=-0.010 replace
contact name=drain  point y=0.12*1.5  x=-0.010 replace
contact name=gate   point y=0         x=-0.050 



struct tdr=n136 !Gas !interfaces
exit
