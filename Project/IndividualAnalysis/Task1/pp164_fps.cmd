...
line y location= 0.0      spacing= 0.1*0.39  tag= Mid
line y location= 0.5*0.39 spacing= 0.05*0.39
line y location= 2*0.39   spacing= 0.39      tag= Right 
...
struct tdr=n164_MOS1 ; # Saving after gate oxidation
...
mask name=gate_mask left=-0.39/2 right= 0.39/2
...
struct tdr=n164_MOS4 ; # Saving after HALO Implant



deposit nitride isotropic thickness= 0.3*0.39
etch  nitride anisotropic thickness= 0.35*0.39
struct tdr=n164_MOS5 ; # Saving after spacer formation
...
struct tdr=n164_MOS6 ; # Saving after souce/drain implantation



deposit material= {Aluminum} type=anisotropic thickness= 0.05
mask name= contacts_mask left=0.39*1.2
...
contact name=source point y=-0.39*1.5 x=-0.010 replace
contact name=drain  point y=0.39*1.5  x=-0.010 replace
contact name=gate   point y=0         x=-0.050 



struct tdr=n164 !Gas !interfaces
exit
