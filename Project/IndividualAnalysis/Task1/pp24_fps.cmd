...
line y location= 0.0      spacing= 0.1*0.21  tag= Mid
line y location= 0.5*0.21 spacing= 0.05*0.21
line y location= 2*0.21   spacing= 0.21      tag= Right 
...
struct tdr=n24_MOS1 ; # Saving after gate oxidation
...
mask name=gate_mask left=-0.21/2 right= 0.21/2
...
struct tdr=n24_MOS4 ; # Saving after HALO Implant



deposit nitride isotropic thickness= 0.3*0.21
etch  nitride anisotropic thickness= 0.35*0.21
struct tdr=n24_MOS5 ; # Saving after spacer formation
...
struct tdr=n24_MOS6 ; # Saving after souce/drain implantation



deposit material= {Aluminum} type=anisotropic thickness= 0.05
mask name= contacts_mask left=0.21*1.2
...
contact name=source point y=-0.21*1.5 x=-0.010 replace
contact name=drain  point y=0.21*1.5  x=-0.010 replace
contact name=gate   point y=0         x=-0.050 



struct tdr=n24 !Gas !interfaces
exit
