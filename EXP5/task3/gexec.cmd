...
job 26 -d "1"  -post { extract_vars "$wdir" n26_des.out 26 }  -o n26_des "sdevice pp26_des.cmd"
job 27 -d "4"  -post { extract_vars "$wdir" n27_des.out 27 }  -o n27_des "sdevice pp27_des.cmd"
job 28 -d "6"  -post { extract_vars "$wdir" n28_des.out 28 }  -o n28_des "sdevice pp28_des.cmd"
job 29 -d "1"  -post { extract_vars "$wdir" n29_des.out 29 }  -o n29_des "sdevice pp29_des.cmd"
job 30 -d "4"  -post { extract_vars "$wdir" n30_des.out 30 }  -o n30_des "sdevice pp30_des.cmd"
job 31 -d "6"  -post { extract_vars "$wdir" n31_des.out 31 }  -o n31_des "sdevice pp31_des.cmd"
...
check sde_dvs.cmd 1603507967
check sdevice_des.cmd 1603508075
check sdevice.par 1603497791
check global_tooldb 1526577858
check gtree.dat 1603502287
check Si.par 1603497769
# included files
