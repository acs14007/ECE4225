...
init concentration=0.02e16 field=Boron
...
struct tdr= n15_wResist

implant Arsenic energy=30<keV> dose=1e12 tilt=7<degree>  rotation=0<degree> 
strip PhotoResist


struct tdr= n15_asImplant


diffuse  temperature=1000<C> time=30<min>

struct tdr= n15_afterAnneal
