...
(define    LOxide	   30e-3)
(define    Height	   10e-3)
(define    TotalLength     (+ LMetal (+ LOxide LMetal)))
...
(sdegeo:create-rectangle
  (position LMetal             0       0)
  (position (+ LMetal LOxide)  Height  0)
  "SiO2" "R.Ox"
)

(sdegeo:create-rectangle
  (position (+ LMetal LOxide)  0       0)
...
(sde:build-mesh  "-a"  "StackA_geo_msh")


;;;;;;;;;;;;Save File;;;;;;;;;;;;;;
;(sde:save-model   ModelName      )
( sde:save-model   "StackA_geo")
