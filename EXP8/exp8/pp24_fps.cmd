...
struct tdr= n24_DepositOxideAndSilicon
...
struct tdr= n24_GateEtch


photo mask = gate_mask thickness=1<um>
implant Arsenic energy=15<keV> dose=1e13 tilt=7<degree>  rotation=0<degree> 
etch material= {Resist} type= anisotropic thickness= 1.5<um>
diffuse  temperature=1000<C> time=1<min> 
struct tdr= n24_AfterImplant
