...
struct tdr= n6_DepositOxideAndSilicon
...
struct tdr= n6_GateEtch


photo mask = gate_mask thickness=1<um>
implant Arsenic energy=5<keV> dose=1e14 tilt=7<degree>  rotation=0<degree> 
etch material= {Resist} type= anisotropic thickness= 1.5<um>
diffuse  temperature=1000<C> time=1<min> 
struct tdr= n6_AfterImplant
