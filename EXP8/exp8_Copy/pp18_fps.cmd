...
struct tdr= n18_DepositOxideAndSilicon
...
struct tdr= n18_GateEtch


photo mask = gate_mask thickness=1<um>
implant Arsenic energy=10<keV> dose=1e14 tilt=7<degree>  rotation=0<degree> 
etch material= {Resist} type= anisotropic thickness= 1.5<um>
diffuse  temperature=1000<C> time=1<min> 
struct tdr= n18_AfterImplant
